...
function MyBooking() {
  ...
  return (
    <div className='w-[100vw] min-h-[100vh] flex items-center justify-start flex-col gap-[50px] relative  px-[20px]'>
        ...
        <div className='w-[60%] h-[10%] border-[2px] border-[#908c8c] p-[15px] flex items-center justify-center text-[30px] rounded-md text-purple-600 font-semibold  mt-[50px] md:w-[600px] text-nowrap'>MY BOOKING</div>
