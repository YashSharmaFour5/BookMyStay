  ...
  return (
     <div className='w-[100vw] min-h-[100vh] flex items-center justify-center relative bg-gray-50'>
        <div className='w-[50px] h-[50px] bg-purple-600 cursor-pointer absolute top-[10%] left-[20px] rounded-[50%] flex items-center justify-center hover:bg-purple-700 transition-colors shadow-lg' onClick={()=>navigate("/")}><FaArrowLeftLong className='w-[25px] h-[25px] text-[white]' /></div>
            <form action="" className='max-w-[500px] w-[90%] bg-white p-8 rounded-2xl shadow-xl flex items-center justify-center flex-col gap-6' onSubmit={handleLogin}>
                <h1 className='text-3xl font-bold text-gray-800 mb-2'>Welcome Back</h1>
                <p className='text-gray-600 mb-6'>Sign in to continue to BookMyStay</p>
                ...
                <p className='text-gray-600'>Don't have an account? <span className='text-purple-600 font-medium cursor-pointer hover:text-purple-700 transition-colors' onClick={()=>navigate("/SignUP")}>Sign Up</span></p>
            </form>
        </div>
  )
}
